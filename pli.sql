...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-02-2016 a las 01:54:01
...
--
-- Estructura de tabla para la tabla `pli_assets`
--

CREATE TABLE IF NOT EXISTS `pli_assets` (
...
--
-- Volcado de datos para la tabla `pli_assets`
--

INSERT INTO `pli_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
--
-- Estructura de tabla para la tabla `pli_associations`
--

CREATE TABLE IF NOT EXISTS `pli_associations` (
...
--
-- Estructura de tabla para la tabla `pli_banners`
--

CREATE TABLE IF NOT EXISTS `pli_banners` (
  `id` int(11) NOT NULL,
...
--
-- Estructura de tabla para la tabla `pli_banner_clients`
--

CREATE TABLE IF NOT EXISTS `pli_banner_clients` (
  `id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Estructura de tabla para la tabla `pli_banner_tracks`
--

CREATE TABLE IF NOT EXISTS `pli_banner_tracks` (
...
--
-- Estructura de tabla para la tabla `pli_categories`
--

CREATE TABLE IF NOT EXISTS `pli_categories` (
  `id` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `pli_categories`
--

INSERT INTO `pli_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
...
--
-- Estructura de tabla para la tabla `pli_contact_details`
--

CREATE TABLE IF NOT EXISTS `pli_contact_details` (
  `id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL DEFAULT '',
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
...
--
-- Estructura de tabla para la tabla `pli_content`
--

CREATE TABLE IF NOT EXISTS `pli_content` (
...
--
-- Estructura de tabla para la tabla `pli_contentitem_tag_map`
--

CREATE TABLE IF NOT EXISTS `pli_contentitem_tag_map` (
...
--
-- Estructura de tabla para la tabla `pli_content_frontpage`
--

CREATE TABLE IF NOT EXISTS `pli_content_frontpage` (
...
--
-- Estructura de tabla para la tabla `pli_content_rating`
--

CREATE TABLE IF NOT EXISTS `pli_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Estructura de tabla para la tabla `pli_content_types`
--

CREATE TABLE IF NOT EXISTS `pli_content_types` (
...
--
-- Volcado de datos para la tabla `pli_content_types`
--

INSERT INTO `pli_content_types` (`type_id`, `type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`, `content_history_options`) VALUES
...
--
-- Estructura de tabla para la tabla `pli_core_log_searches`
--

CREATE TABLE IF NOT EXISTS `pli_core_log_searches` (
...
--
-- Estructura de tabla para la tabla `pli_extensions`
--

CREATE TABLE IF NOT EXISTS `pli_extensions` (
...
--
-- Volcado de datos para la tabla `pli_extensions`
--

INSERT INTO `pli_extensions` (`extension_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
(103, 'Joomla! Platform', 'library', 'joomla', '', 0, 1, 1, 1, '{"name":"Joomla! Platform","type":"library","creationDate":"2008","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2015 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"http:\\/\\/www.joomla.org","version":"13.1","description":"LIB_JOOMLA_XML_DESCRIPTION","group":"","filename":"joomla"}', '{"mediaversion":"28db8bbac3e890657dd980075ae916fe"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
--
-- Estructura de tabla para la tabla `pli_finder_filters`
--

CREATE TABLE IF NOT EXISTS `pli_finder_filters` (
...
--
-- Estructura de tabla para la tabla `pli_finder_links`
--

CREATE TABLE IF NOT EXISTS `pli_finder_links` (
...
--
-- Estructura de tabla para la tabla `pli_finder_links_terms0`
--

CREATE TABLE IF NOT EXISTS `pli_finder_links_terms0` (
  `link_id` int(10) unsigned NOT NULL,
...
--
-- Estructura de tabla para la tabla `pli_finder_links_terms1`
--

CREATE TABLE IF NOT EXISTS `pli_finder_links_terms1` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Estructura de tabla para la tabla `pli_finder_links_terms2`
--

CREATE TABLE IF NOT EXISTS `pli_finder_links_terms2` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Estructura de tabla para la tabla `pli_finder_links_terms3`
--

CREATE TABLE IF NOT EXISTS `pli_finder_links_terms3` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Estructura de tabla para la tabla `pli_finder_links_terms4`
--

CREATE TABLE IF NOT EXISTS `pli_finder_links_terms4` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Estructura de tabla para la tabla `pli_finder_links_terms5`
--

CREATE TABLE IF NOT EXISTS `pli_finder_links_terms5` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Estructura de tabla para la tabla `pli_finder_links_terms6`
--

CREATE TABLE IF NOT EXISTS `pli_finder_links_terms6` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Estructura de tabla para la tabla `pli_finder_links_terms7`
--

CREATE TABLE IF NOT EXISTS `pli_finder_links_terms7` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Estructura de tabla para la tabla `pli_finder_links_terms8`
--

CREATE TABLE IF NOT EXISTS `pli_finder_links_terms8` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Estructura de tabla para la tabla `pli_finder_links_terms9`
--

CREATE TABLE IF NOT EXISTS `pli_finder_links_terms9` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Estructura de tabla para la tabla `pli_finder_links_termsa`
--

CREATE TABLE IF NOT EXISTS `pli_finder_links_termsa` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Estructura de tabla para la tabla `pli_finder_links_termsb`
--

CREATE TABLE IF NOT EXISTS `pli_finder_links_termsb` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Estructura de tabla para la tabla `pli_finder_links_termsc`
--

CREATE TABLE IF NOT EXISTS `pli_finder_links_termsc` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Estructura de tabla para la tabla `pli_finder_links_termsd`
--

CREATE TABLE IF NOT EXISTS `pli_finder_links_termsd` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Estructura de tabla para la tabla `pli_finder_links_termse`
--

CREATE TABLE IF NOT EXISTS `pli_finder_links_termse` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Estructura de tabla para la tabla `pli_finder_links_termsf`
--

CREATE TABLE IF NOT EXISTS `pli_finder_links_termsf` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Estructura de tabla para la tabla `pli_finder_taxonomy`
--

CREATE TABLE IF NOT EXISTS `pli_finder_taxonomy` (
  `id` int(10) unsigned NOT NULL,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
--
-- Volcado de datos para la tabla `pli_finder_taxonomy`
--

INSERT INTO `pli_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `pli_finder_taxonomy_map`
--

CREATE TABLE IF NOT EXISTS `pli_finder_taxonomy_map` (
  `link_id` int(10) unsigned NOT NULL,
...
--
-- Estructura de tabla para la tabla `pli_finder_terms`
--

CREATE TABLE IF NOT EXISTS `pli_finder_terms` (
  `term_id` int(10) unsigned NOT NULL,
...
--
-- Estructura de tabla para la tabla `pli_finder_terms_common`
--

CREATE TABLE IF NOT EXISTS `pli_finder_terms_common` (
  `term` varchar(75) NOT NULL,
  `language` varchar(3) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Volcado de datos para la tabla `pli_finder_terms_common`
--

INSERT INTO `pli_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Estructura de tabla para la tabla `pli_finder_tokens`
--

CREATE TABLE IF NOT EXISTS `pli_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `phrase` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
--
-- Estructura de tabla para la tabla `pli_finder_tokens_aggregate`
--

CREATE TABLE IF NOT EXISTS `pli_finder_tokens_aggregate` (
  `term_id` int(10) unsigned NOT NULL,
...
--
-- Estructura de tabla para la tabla `pli_finder_types`
--

CREATE TABLE IF NOT EXISTS `pli_finder_types` (
  `id` int(10) unsigned NOT NULL,
...
--
-- Estructura de tabla para la tabla `pli_languages`
--

CREATE TABLE IF NOT EXISTS `pli_languages` (
...
--
-- Volcado de datos para la tabla `pli_languages`
--

INSERT INTO `pli_languages` (`lang_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
(1, 'en-GB', 'English (UK)', 'English (UK)', 'en', 'en', '', '', '', '', 1, 1, 1);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `pli_menu`
--

CREATE TABLE IF NOT EXISTS `pli_menu` (
  `id` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `pli_menu`
--

INSERT INTO `pli_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
--
-- Estructura de tabla para la tabla `pli_menu_types`
--

CREATE TABLE IF NOT EXISTS `pli_menu_types` (
  `id` int(10) unsigned NOT NULL,
...
--
-- Volcado de datos para la tabla `pli_menu_types`
--

INSERT INTO `pli_menu_types` (`id`, `menutype`, `title`, `description`) VALUES
(1, 'mainmenu', 'Main Menu', 'The main menu for the site');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `pli_messages`
--

CREATE TABLE IF NOT EXISTS `pli_messages` (
...
--
-- Estructura de tabla para la tabla `pli_messages_cfg`
--

CREATE TABLE IF NOT EXISTS `pli_messages_cfg` (
...
--
-- Estructura de tabla para la tabla `pli_modules`
--

CREATE TABLE IF NOT EXISTS `pli_modules` (
  `id` int(11) NOT NULL,
  `asset_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
...
--
-- Volcado de datos para la tabla `pli_modules`
--

INSERT INTO `pli_modules` (`id`, `asset_id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
...
--
-- Estructura de tabla para la tabla `pli_modules_menu`
--

CREATE TABLE IF NOT EXISTS `pli_modules_menu` (
  `moduleid` int(11) NOT NULL DEFAULT '0',
  `menuid` int(11) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Volcado de datos para la tabla `pli_modules_menu`
--

INSERT INTO `pli_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Estructura de tabla para la tabla `pli_newsfeeds`
--

CREATE TABLE IF NOT EXISTS `pli_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) unsigned NOT NULL,
...
--
-- Estructura de tabla para la tabla `pli_overrider`
--

CREATE TABLE IF NOT EXISTS `pli_overrider` (
...
--
-- Estructura de tabla para la tabla `pli_postinstall_messages`
--

CREATE TABLE IF NOT EXISTS `pli_postinstall_messages` (
...
--
-- Volcado de datos para la tabla `pli_postinstall_messages`
--

INSERT INTO `pli_postinstall_messages` (`postinstall_message_id`, `extension_id`, `title_key`, `description_key`, `action_key`, `language_extension`, `language_client_id`, `type`, `action_file`, `action`, `condition_file`, `condition_method`, `version_introduced`, `enabled`) VALUES
...
--
-- Estructura de tabla para la tabla `pli_redirect_links`
--

CREATE TABLE IF NOT EXISTS `pli_redirect_links` (
  `id` int(10) unsigned NOT NULL,
...
--
-- Estructura de tabla para la tabla `pli_schemas`
--

CREATE TABLE IF NOT EXISTS `pli_schemas` (
  `extension_id` int(11) NOT NULL,
  `version_id` varchar(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Volcado de datos para la tabla `pli_schemas`
--

INSERT INTO `pli_schemas` (`extension_id`, `version_id`) VALUES
(700, '3.4.0-2015-02-26');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `pli_session`
--

CREATE TABLE IF NOT EXISTS `pli_session` (
...
--
-- Volcado de datos para la tabla `pli_session`
--

INSERT INTO `pli_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`) VALUES
('dsb61elo3lfu9b3j0k9579f3q1', 1, 0, '1456324144', 'joomla|s:2164:"";', 863, 'administrator');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `pli_tags`
--

CREATE TABLE IF NOT EXISTS `pli_tags` (
  `id` int(10) unsigned NOT NULL,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `lft` int(11) NOT NULL DEFAULT '0',
  `rgt` int(11) NOT NULL DEFAULT '0',
...
--
-- Volcado de datos para la tabla `pli_tags`
--

INSERT INTO `pli_tags` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `created_by_alias`, `modified_user_id`, `modified_time`, `images`, `urls`, `hits`, `language`, `version`, `publish_up`, `publish_down`) VALUES
...
--
-- Estructura de tabla para la tabla `pli_template_styles`
--

CREATE TABLE IF NOT EXISTS `pli_template_styles` (
  `id` int(10) unsigned NOT NULL,
...
--
-- Volcado de datos para la tabla `pli_template_styles`
--

INSERT INTO `pli_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
...
--
-- Estructura de tabla para la tabla `pli_ucm_base`
--

CREATE TABLE IF NOT EXISTS `pli_ucm_base` (
...
--
-- Estructura de tabla para la tabla `pli_ucm_content`
--

CREATE TABLE IF NOT EXISTS `pli_ucm_content` (
...
--
-- Estructura de tabla para la tabla `pli_ucm_history`
--

CREATE TABLE IF NOT EXISTS `pli_ucm_history` (
...
--
-- Estructura de tabla para la tabla `pli_updates`
--

CREATE TABLE IF NOT EXISTS `pli_updates` (
...
--
-- Volcado de datos para la tabla `pli_updates`
--

INSERT INTO `pli_updates` (`update_id`, `update_site_id`, `extension_id`, `name`, `description`, `element`, `type`, `folder`, `client_id`, `version`, `data`, `detailsurl`, `infourl`, `extra_query`) VALUES
...
--
-- Estructura de tabla para la tabla `pli_update_sites`
--

CREATE TABLE IF NOT EXISTS `pli_update_sites` (
...
--
-- Volcado de datos para la tabla `pli_update_sites`
--

INSERT INTO `pli_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`, `extra_query`) VALUES
(1, 'Joomla! Core', 'collection', 'http://update.joomla.org/core/list.xml', 1, 1456324131, ''),
(2, 'Joomla! Extension Directory', 'collection', 'http://update.joomla.org/jed/list.xml', 1, 1456324131, ''),
(3, 'Accredited Joomla! Translations', 'collection', 'http://update.joomla.org/language/translationlist_3.xml', 1, 1456324131, ''),
(4, 'Joomla! Update Component Update Site', 'extension', 'http://update.joomla.org/core/extensions/com_joomlaupdate.xml', 1, 1456324131, '');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `pli_update_sites_extensions`
--

CREATE TABLE IF NOT EXISTS `pli_update_sites_extensions` (
  `update_site_id` int(11) NOT NULL DEFAULT '0',
  `extension_id` int(11) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Links extensions to update sites';

--
-- Volcado de datos para la tabla `pli_update_sites_extensions`
--

INSERT INTO `pli_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 700),
(3, 600),
(4, 28);
...
--
-- Estructura de tabla para la tabla `pli_usergroups`
--

CREATE TABLE IF NOT EXISTS `pli_usergroups` (
  `id` int(10) unsigned NOT NULL COMMENT 'Primary Key',
...
--
-- Volcado de datos para la tabla `pli_usergroups`
--

INSERT INTO `pli_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 18, 'Public'),
(2, 1, 8, 15, 'Registered'),
(3, 2, 9, 14, 'Author'),
(4, 3, 10, 13, 'Editor'),
...
--
-- Estructura de tabla para la tabla `pli_users`
--

CREATE TABLE IF NOT EXISTS `pli_users` (
  `id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Volcado de datos para la tabla `pli_users`
--

INSERT INTO `pli_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`, `otpKey`, `otep`, `requireReset`) VALUES
(863, 'Super User', 'administrator', 'dpto.sistemas@plindustrias.com', '$2y$10$niZdZ.u5lZM2/FJVnsgvJeMyN1jc3TNPxnDQiv5U6pv.IpURyi4tW', 0, 1, '2016-02-24 14:26:43', '2016-02-24 14:28:39', '0', '', '0000-00-00 00:00:00', 0, '', '', 0);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `pli_user_keys`
--

CREATE TABLE IF NOT EXISTS `pli_user_keys` (
  `id` int(10) unsigned NOT NULL,
...
--
-- Estructura de tabla para la tabla `pli_user_notes`
--

CREATE TABLE IF NOT EXISTS `pli_user_notes` (
  `id` int(10) unsigned NOT NULL,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `catid` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Estructura de tabla para la tabla `pli_user_profiles`
--

CREATE TABLE IF NOT EXISTS `pli_user_profiles` (
...
--
-- Estructura de tabla para la tabla `pli_user_usergroup_map`
--

CREATE TABLE IF NOT EXISTS `pli_user_usergroup_map` (
  `user_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Foreign Key to #__users.id',
  `group_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Foreign Key to #__usergroups.id'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Volcado de datos para la tabla `pli_user_usergroup_map`
--

INSERT INTO `pli_user_usergroup_map` (`user_id`, `group_id`) VALUES
(863, 8);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `pli_viewlevels`
--

CREATE TABLE IF NOT EXISTS `pli_viewlevels` (
  `id` int(10) unsigned NOT NULL COMMENT 'Primary Key',
  `title` varchar(100) NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) NOT NULL COMMENT 'JSON encoded access control.'
...
--
-- Volcado de datos para la tabla `pli_viewlevels`
--

INSERT INTO `pli_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
...
--
-- Indices de la tabla `pli_assets`
--
ALTER TABLE `pli_assets`
  ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `idx_asset_name` (`name`), ADD KEY `idx_lft_rgt` (`lft`,`rgt`), ADD KEY `idx_parent_id` (`parent_id`);

--
-- Indices de la tabla `pli_associations`
--
ALTER TABLE `pli_associations`
  ADD PRIMARY KEY (`context`,`id`), ADD KEY `idx_key` (`key`);

--
-- Indices de la tabla `pli_banners`
--
ALTER TABLE `pli_banners`
...
--
-- Indices de la tabla `pli_banner_clients`
--
ALTER TABLE `pli_banner_clients`
  ADD PRIMARY KEY (`id`), ADD KEY `idx_own_prefix` (`own_prefix`), ADD KEY `idx_metakey_prefix` (`metakey_prefix`);

--
-- Indices de la tabla `pli_banner_tracks`
--
ALTER TABLE `pli_banner_tracks`
...
--
-- Indices de la tabla `pli_categories`
--
ALTER TABLE `pli_categories`
...
--
-- Indices de la tabla `pli_contact_details`
--
ALTER TABLE `pli_contact_details`
...
--
-- Indices de la tabla `pli_content`
--
ALTER TABLE `pli_content`
...
--
-- Indices de la tabla `pli_contentitem_tag_map`
--
ALTER TABLE `pli_contentitem_tag_map`
...
--
-- Indices de la tabla `pli_content_frontpage`
--
ALTER TABLE `pli_content_frontpage`
  ADD PRIMARY KEY (`content_id`);

--
-- Indices de la tabla `pli_content_rating`
--
ALTER TABLE `pli_content_rating`
  ADD PRIMARY KEY (`content_id`);

--
-- Indices de la tabla `pli_content_types`
--
ALTER TABLE `pli_content_types`
  ADD PRIMARY KEY (`type_id`), ADD KEY `idx_alias` (`type_alias`);

--
-- Indices de la tabla `pli_extensions`
--
ALTER TABLE `pli_extensions`
...
--
-- Indices de la tabla `pli_finder_filters`
--
ALTER TABLE `pli_finder_filters`
  ADD PRIMARY KEY (`filter_id`);

--
-- Indices de la tabla `pli_finder_links`
--
ALTER TABLE `pli_finder_links`
...
--
-- Indices de la tabla `pli_finder_links_terms0`
--
ALTER TABLE `pli_finder_links_terms0`
...
--
-- Indices de la tabla `pli_finder_links_terms1`
--
ALTER TABLE `pli_finder_links_terms1`
  ADD PRIMARY KEY (`link_id`,`term_id`), ADD KEY `idx_term_weight` (`term_id`,`weight`), ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `pli_finder_links_terms2`
--
ALTER TABLE `pli_finder_links_terms2`
  ADD PRIMARY KEY (`link_id`,`term_id`), ADD KEY `idx_term_weight` (`term_id`,`weight`), ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `pli_finder_links_terms3`
--
ALTER TABLE `pli_finder_links_terms3`
  ADD PRIMARY KEY (`link_id`,`term_id`), ADD KEY `idx_term_weight` (`term_id`,`weight`), ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `pli_finder_links_terms4`
--
ALTER TABLE `pli_finder_links_terms4`
  ADD PRIMARY KEY (`link_id`,`term_id`), ADD KEY `idx_term_weight` (`term_id`,`weight`), ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `pli_finder_links_terms5`
--
ALTER TABLE `pli_finder_links_terms5`
  ADD PRIMARY KEY (`link_id`,`term_id`), ADD KEY `idx_term_weight` (`term_id`,`weight`), ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `pli_finder_links_terms6`
--
ALTER TABLE `pli_finder_links_terms6`
  ADD PRIMARY KEY (`link_id`,`term_id`), ADD KEY `idx_term_weight` (`term_id`,`weight`), ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `pli_finder_links_terms7`
--
ALTER TABLE `pli_finder_links_terms7`
  ADD PRIMARY KEY (`link_id`,`term_id`), ADD KEY `idx_term_weight` (`term_id`,`weight`), ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `pli_finder_links_terms8`
--
ALTER TABLE `pli_finder_links_terms8`
  ADD PRIMARY KEY (`link_id`,`term_id`), ADD KEY `idx_term_weight` (`term_id`,`weight`), ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `pli_finder_links_terms9`
--
ALTER TABLE `pli_finder_links_terms9`
  ADD PRIMARY KEY (`link_id`,`term_id`), ADD KEY `idx_term_weight` (`term_id`,`weight`), ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `pli_finder_links_termsa`
--
ALTER TABLE `pli_finder_links_termsa`
  ADD PRIMARY KEY (`link_id`,`term_id`), ADD KEY `idx_term_weight` (`term_id`,`weight`), ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `pli_finder_links_termsb`
--
ALTER TABLE `pli_finder_links_termsb`
  ADD PRIMARY KEY (`link_id`,`term_id`), ADD KEY `idx_term_weight` (`term_id`,`weight`), ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `pli_finder_links_termsc`
--
ALTER TABLE `pli_finder_links_termsc`
  ADD PRIMARY KEY (`link_id`,`term_id`), ADD KEY `idx_term_weight` (`term_id`,`weight`), ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `pli_finder_links_termsd`
--
ALTER TABLE `pli_finder_links_termsd`
  ADD PRIMARY KEY (`link_id`,`term_id`), ADD KEY `idx_term_weight` (`term_id`,`weight`), ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `pli_finder_links_termse`
--
ALTER TABLE `pli_finder_links_termse`
  ADD PRIMARY KEY (`link_id`,`term_id`), ADD KEY `idx_term_weight` (`term_id`,`weight`), ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `pli_finder_links_termsf`
--
ALTER TABLE `pli_finder_links_termsf`
  ADD PRIMARY KEY (`link_id`,`term_id`), ADD KEY `idx_term_weight` (`term_id`,`weight`), ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `pli_finder_taxonomy`
--
ALTER TABLE `pli_finder_taxonomy`
...
--
-- Indices de la tabla `pli_finder_taxonomy_map`
--
ALTER TABLE `pli_finder_taxonomy_map`
  ADD PRIMARY KEY (`link_id`,`node_id`), ADD KEY `link_id` (`link_id`), ADD KEY `node_id` (`node_id`);

--
-- Indices de la tabla `pli_finder_terms`
--
ALTER TABLE `pli_finder_terms`
...
--
-- Indices de la tabla `pli_finder_terms_common`
--
ALTER TABLE `pli_finder_terms_common`
  ADD KEY `idx_word_lang` (`term`,`language`), ADD KEY `idx_lang` (`language`);

--
-- Indices de la tabla `pli_finder_tokens`
--
ALTER TABLE `pli_finder_tokens`
  ADD KEY `idx_word` (`term`), ADD KEY `idx_context` (`context`);

--
-- Indices de la tabla `pli_finder_tokens_aggregate`
--
ALTER TABLE `pli_finder_tokens_aggregate`
  ADD KEY `token` (`term`), ADD KEY `keyword_id` (`term_id`);

--
-- Indices de la tabla `pli_finder_types`
--
ALTER TABLE `pli_finder_types`
  ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `title` (`title`);

--
-- Indices de la tabla `pli_languages`
--
...
--
-- Indices de la tabla `pli_menu`
--
ALTER TABLE `pli_menu`
...
--
-- Indices de la tabla `pli_menu_types`
--
ALTER TABLE `pli_menu_types`
  ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `idx_menutype` (`menutype`);

--
-- Indices de la tabla `pli_messages`
--
ALTER TABLE `pli_messages`
  ADD PRIMARY KEY (`message_id`), ADD KEY `useridto_state` (`user_id_to`,`state`);

--
-- Indices de la tabla `pli_messages_cfg`
--
ALTER TABLE `pli_messages_cfg`
  ADD UNIQUE KEY `idx_user_var_name` (`user_id`,`cfg_name`);

--
-- Indices de la tabla `pli_modules`
--
ALTER TABLE `pli_modules`
  ADD PRIMARY KEY (`id`), ADD KEY `published` (`published`,`access`), ADD KEY `newsfeeds` (`module`,`published`), ADD KEY `idx_language` (`language`);

--
-- Indices de la tabla `pli_modules_menu`
--
ALTER TABLE `pli_modules_menu`
  ADD PRIMARY KEY (`moduleid`,`menuid`);

--
-- Indices de la tabla `pli_newsfeeds`
--
ALTER TABLE `pli_newsfeeds`
...
--
-- Indices de la tabla `pli_overrider`
--
ALTER TABLE `pli_overrider`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `pli_postinstall_messages`
--
ALTER TABLE `pli_postinstall_messages`
  ADD PRIMARY KEY (`postinstall_message_id`);

--
-- Indices de la tabla `pli_redirect_links`
--
ALTER TABLE `pli_redirect_links`
  ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `idx_link_old` (`old_url`), ADD KEY `idx_link_modifed` (`modified_date`);

--
-- Indices de la tabla `pli_schemas`
--
ALTER TABLE `pli_schemas`
  ADD PRIMARY KEY (`extension_id`,`version_id`);

--
-- Indices de la tabla `pli_session`
--
ALTER TABLE `pli_session`
  ADD PRIMARY KEY (`session_id`), ADD KEY `userid` (`userid`), ADD KEY `time` (`time`);

--
-- Indices de la tabla `pli_tags`
--
ALTER TABLE `pli_tags`
...
--
-- Indices de la tabla `pli_template_styles`
--
ALTER TABLE `pli_template_styles`
  ADD PRIMARY KEY (`id`), ADD KEY `idx_template` (`template`), ADD KEY `idx_home` (`home`);

--
-- Indices de la tabla `pli_ucm_base`
--
ALTER TABLE `pli_ucm_base`
...
--
-- Indices de la tabla `pli_ucm_content`
--
ALTER TABLE `pli_ucm_content`
...
--
-- Indices de la tabla `pli_ucm_history`
--
ALTER TABLE `pli_ucm_history`
  ADD PRIMARY KEY (`version_id`), ADD KEY `idx_ucm_item_id` (`ucm_type_id`,`ucm_item_id`), ADD KEY `idx_save_date` (`save_date`);

--
-- Indices de la tabla `pli_updates`
--
ALTER TABLE `pli_updates`
  ADD PRIMARY KEY (`update_id`);

--
-- Indices de la tabla `pli_update_sites`
--
ALTER TABLE `pli_update_sites`
  ADD PRIMARY KEY (`update_site_id`);

--
-- Indices de la tabla `pli_update_sites_extensions`
--
ALTER TABLE `pli_update_sites_extensions`
  ADD PRIMARY KEY (`update_site_id`,`extension_id`);

--
-- Indices de la tabla `pli_usergroups`
--
ALTER TABLE `pli_usergroups`
...
--
-- Indices de la tabla `pli_user_keys`
--
ALTER TABLE `pli_user_keys`
...
--
-- Indices de la tabla `pli_user_notes`
--
ALTER TABLE `pli_user_notes`
  ADD PRIMARY KEY (`id`), ADD KEY `idx_user_id` (`user_id`), ADD KEY `idx_category_id` (`catid`);

--
-- Indices de la tabla `pli_user_profiles`
--
ALTER TABLE `pli_user_profiles`
  ADD UNIQUE KEY `idx_user_id_profile_key` (`user_id`,`profile_key`);

--
-- Indices de la tabla `pli_user_usergroup_map`
--
ALTER TABLE `pli_user_usergroup_map`
  ADD PRIMARY KEY (`user_id`,`group_id`);

--
-- Indices de la tabla `pli_viewlevels`
--
ALTER TABLE `pli_viewlevels`
...
--
-- AUTO_INCREMENT de la tabla `pli_assets`
--
ALTER TABLE `pli_assets`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',AUTO_INCREMENT=54;
--
-- AUTO_INCREMENT de la tabla `pli_banners`
--
ALTER TABLE `pli_banners`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `pli_banner_clients`
--
ALTER TABLE `pli_banner_clients`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `pli_categories`
--
ALTER TABLE `pli_categories`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=8;
--
-- AUTO_INCREMENT de la tabla `pli_contact_details`
--
ALTER TABLE `pli_contact_details`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `pli_content`
--
ALTER TABLE `pli_content`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `pli_content_types`
--
ALTER TABLE `pli_content_types`
  MODIFY `type_id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=14;
--
-- AUTO_INCREMENT de la tabla `pli_extensions`
--
ALTER TABLE `pli_extensions`
  MODIFY `extension_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=701;
--
-- AUTO_INCREMENT de la tabla `pli_finder_filters`
--
ALTER TABLE `pli_finder_filters`
  MODIFY `filter_id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `pli_finder_links`
--
ALTER TABLE `pli_finder_links`
  MODIFY `link_id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `pli_finder_taxonomy`
--
ALTER TABLE `pli_finder_taxonomy`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT de la tabla `pli_finder_terms`
--
ALTER TABLE `pli_finder_terms`
  MODIFY `term_id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `pli_finder_types`
--
ALTER TABLE `pli_finder_types`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `pli_languages`
--
ALTER TABLE `pli_languages`
  MODIFY `lang_id` int(11) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT de la tabla `pli_menu`
--
ALTER TABLE `pli_menu`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=102;
--
-- AUTO_INCREMENT de la tabla `pli_menu_types`
--
ALTER TABLE `pli_menu_types`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT de la tabla `pli_messages`
--
ALTER TABLE `pli_messages`
  MODIFY `message_id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `pli_modules`
--
ALTER TABLE `pli_modules`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=87;
--
-- AUTO_INCREMENT de la tabla `pli_newsfeeds`
--
ALTER TABLE `pli_newsfeeds`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `pli_overrider`
--
ALTER TABLE `pli_overrider`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT COMMENT 'Primary Key';
--
-- AUTO_INCREMENT de la tabla `pli_postinstall_messages`
--
ALTER TABLE `pli_postinstall_messages`
  MODIFY `postinstall_message_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT de la tabla `pli_redirect_links`
--
ALTER TABLE `pli_redirect_links`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `pli_tags`
--
ALTER TABLE `pli_tags`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT de la tabla `pli_template_styles`
--
ALTER TABLE `pli_template_styles`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT de la tabla `pli_ucm_content`
--
ALTER TABLE `pli_ucm_content`
  MODIFY `core_content_id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `pli_ucm_history`
--
ALTER TABLE `pli_ucm_history`
  MODIFY `version_id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `pli_updates`
--
ALTER TABLE `pli_updates`
  MODIFY `update_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=65;
--
-- AUTO_INCREMENT de la tabla `pli_update_sites`
--
ALTER TABLE `pli_update_sites`
  MODIFY `update_site_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT de la tabla `pli_usergroups`
--
ALTER TABLE `pli_usergroups`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT de la tabla `pli_users`
--
ALTER TABLE `pli_users`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=864;
--
-- AUTO_INCREMENT de la tabla `pli_user_keys`
--
ALTER TABLE `pli_user_keys`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `pli_user_notes`
--
ALTER TABLE `pli_user_notes`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `pli_viewlevels`
--
ALTER TABLE `pli_viewlevels`
